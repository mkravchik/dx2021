...
namespace NCompress {
namespace NBZip2 {
const unsigned kMaxHuffmanLenForEncoding = 16;
...
HRESULT CThreadInfo::Create() {
  { WRes __result_ = (StreamWasFinishedEvent.Create()); if (__result_ != 0) return __result_; };
  { WRes __result_ = (WaitingWasStartedEvent.Create()); if (__result_ != 0) return __result_; };
  { WRes __result_ = (CanWriteEvent.Create()); if (__result_ != 0) return __result_; };
  { WRes __result_ = (Thread.Create(MFThread, this)); if (__result_ != 0) return __result_; };
  return S_OK; }
...
HRESULT CEncoder::Create() {
  { WRes __result_ = (CanProcessEvent.CreateIfNotCreated()); if (__result_ != 0) return __result_; };
  { WRes __result_ = (CanStartWaitingEvent.CreateIfNotCreated()); if (__result_ != 0) return __result_; };
