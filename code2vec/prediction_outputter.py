...
def get_prediction_output(SET_NAME):
...
def get_predict_lables(SET_NAME):
    return get_prediction_output(SET_NAME)[0]

if __name__ == "__main__":
    labels,code_vectors = get_prediction_output(SET_NAME)
    # PCA visualization
