...
static const CFormatInfo g_Formats[] = { {
    ...
    "7z",
    (1 << 0) | (1 << 1) | (1 << 3) | (1 << 5) | (1 << 7) | (1 << 9),
    ARRAY_SIZE(g_7zMethods), g_7zMethods,
    true, true, true, true, true, true
  }, {
    "Zip",
    (1 << 0) | (1 << 1) | (1 << 3) | (1 << 5) | (1 << 7) | (1 << 9),
    ARRAY_SIZE(g_ZipMethods), g_ZipMethods,
    false, false, true, false, true, false
  }, {
    "GZip",
    (1 << 1) | (1 << 5) | (1 << 7) | (1 << 9),
    ARRAY_SIZE(g_GZipMethods), g_GZipMethods,
    false, false, false, false, false, false
  }, {
    "BZip2",
    (1 << 1) | (1 << 3) | (1 << 5) | (1 << 7) | (1 << 9),
    ARRAY_SIZE(g_BZip2Methods), g_BZip2Methods,
    false, false, true, false, false, false
  }, {
    "xz",
    (1 << 1) | (1 << 3) | (1 << 5) | (1 << 7) | (1 << 9),
    ARRAY_SIZE(g_XzMethods), g_XzMethods,
    false, true, true, false, false, false
  }, {
    "Swfc",
    (1 << 1) | (1 << 3) | (1 << 5) | (1 << 7) | (1 << 9),
    ARRAY_SIZE(g_SwfcMethods), g_SwfcMethods,
    false, false, true, false, false, false
  }, {
    "Tar",
    (1 << 0),
...
void CCompressDialog::OnHelp() {
  ShowHelpWindow("fm/plugins/7-zip/add.htm"); }
